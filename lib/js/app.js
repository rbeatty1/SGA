            ...
            // Action 1 (Click)
                ...
                function layerClick(e){
                    ...
                    // get filtered muni layer
                        ...
                        /* This throws an error - version issue?
                        var muni = new L.GeoJSON();
                        map.addLayer(muni);
                        ...
                        function parseJSONP(data){
                        	console.log(data); // this is fine
                        	esri2geo.toGeoJSON(data, function(d){
                        		muni.addGeoJSON(d); // this is fucked
                        	});
                        }
                        */
