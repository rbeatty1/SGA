...
d3.json("lib/data/countyjoin.json", function(data){
	for (var i=0; i < data.features.length; i++){
		countyData.push(data.features[i].properties);
	}
	});
	...
	// DVRPC Region //
		...
		// Styling functions
			...
			function defineStyle(f){
				return{
					fillColor: getColor(f.properties.total),
					fillOpacity: .7, 
					color: '#fff',
					opacity: 1,
					weight: 2
